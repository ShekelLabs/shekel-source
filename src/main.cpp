...
uint256 hashGenesisBlock("0xbab314bbe3d0788fdddc9b47bf26fdbf3aaaeef256615ac0423edb9a8a17c5a8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Shekel: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Shekel Signed Message:\n";
...
{
    // Shekel: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Shekel: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Shekel: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1508939417, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e01988d5af1709ed2d07623378e87e47a34081b0aa38f880dd42548e44e6151f32e96362728b06573480e0275ee2cd75ddc73a52ac0e305cdc043c2a0aac98c3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1508939417;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2861026;
        ...
        assert(block.hashMerkleRoot == uint256("0xf021b8f415dd834c04c5931c21238e7ad8a2e574ba5e7a01a600d345c5fa9da0"));
...
unsigned char pchMessageStart[4] = { 0xc5, 0x0b, 0x0a, 0x86 }; // Shekel: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ShekelMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ShekelMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static ShekelMiner(CWallet *pwallet)
{
    printf("ShekelMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("shekel-miner");
    ...
    try { loop {
        ...
        printf("Running ShekelMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&ShekelMiner, pwallet));
}
